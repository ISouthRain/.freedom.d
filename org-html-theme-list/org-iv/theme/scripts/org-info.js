 ...
 * @maintainer m31271n
 *
 * m31271n> Original author doesn't maintain this anymore.
 *
...
var org_html_manager = {
  ...
  build: function ()
  {
    ...
    {
      this.SECS[i].IDX = i;
      var html = '<table class="org-info-js_info-navigation">'
  ...
  showSection: function (sec)
  {
    ...
    if('?/toc/?' == sec || (!isNaN(section) && t.SECS[section])) {
      if('?/toc/?' == sec && t.HIDE_TOC) {
        ...
        t.WINDOW.innerHTML = t.NODE.NAV + t.NODE.DIV.innerHTML;
        t.NODE.hide();
  ...
  showHelp: function ()
  {
    ...
    /* This is an OrgMode version of the table. Turn on orgtbl-mode in
     ...
     | a / e        | goto the first / last section                           |
     | g            | goto section...                                         |
	...
	+'<tr><td><kbd>n</kbd> / <kbd>p</kbd></td><td>goto the next / previous section</td></tr>'
	+'<tr><td><kbd>N</kbd> / <kbd>P</kbd></td><td>goto the next / previous sibling</td></tr>'
	+'<tr><td><kbd>a</kbd> / <kbd>e</kbd></td><td>goto the first / last section</td></tr>'
	+'<tr><td><kbd>g</kbd></td><td>goto section...</td></tr>'
	+'<tr><td><kbd>u</kbd></td><td>go one level up (parent section)</td></tr>'
	+'<tr><td><kbd>i</kbd> / <kbd>C</kbd></td><td>show table of contents / tags index</td></tr>'
	+'<tr><td><kbd>b</kbd> / <kbd>B</kbd></td><td>go back to last / forward to next visited section.</td></tr>'
	+'</tbody><tbody>'
	+'<tr><td></td><td>View</td></tr>'
	+'<tr><td><kbd>v</kbd> / <kbd>V</kbd></td><td>scroll down / up</td></tr>'
